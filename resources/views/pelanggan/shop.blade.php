...
@section('contentUser')
    ...
    <div class="container-fluid mb-5" style="background-color: #ffc40c;">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3 text-white">Belanja</h1>
            <div class="d-inline-flex">
                <p class="m-0 text-white"><a href="/homeUser">Beranda</a></p>
                <p class="m-0 px-2 text-white">-</p>
                <p class="m-0 text-white">Belanja</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
    ...
    <div class="container-fluid pt-5">
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">Belanja</span></h2>
        </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    ...
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        <a href="/detailshopUser/{{ $d->id }}" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>Lihat Detail</a>
