                    ...
                    <table class="table table-bordered text-center mb-0">
                        ...
                        <tbody class="align-middle">
                            ...
                            <tr>
                                ...
                                <td class="align-middle">{{ date('d/M/Y', strtotime($row->tgl_acara)) }} {{ $row->waktu_acara }}</td>
                                ...
                                <td class="align-middle">
                                    ...
                                    @elseif($row->status == 'Tolak')
                                        ...
                                        <br><text><b>DP tidak valid</b></text>
                                    @else
                                        <div class="badge badge-danger badge-sm">{{ $row->status }}</div>
                                    @endif
                                </td>
                                ...
                                <td class="align-middle">
                                    ...
                                    <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="#modalDP{{ $row->id }}" data-toggle="modal"><i class="fa fa-upload"></i> Upload Bukti DP Ulang</a>
                                                <div class="dropdown-divider"></div>
                                                <a class="dropdown-item" href="/pesanan/detailpesanan/{{ $row->no_transaksi }}"><i class="fa fa-list"></i> Detail Data</a>
                                            </div>
                                        </div>
