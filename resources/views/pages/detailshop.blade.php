        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 pb-5">
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    ...
                    <a href="/login" class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i> Tambah Keranjang</a>
                </div>
                ...
                <div class="owl-carousel related-carousel">
                    ...
                    <div class="card product-item border-0">
                        ...
                        <div class="card-footer d-flex justify-content-between bg-light border">
                            <a href="/detailshop/{{ $row->id }}" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>Lihat Detail</a>
                            <a href="/login" class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Tambah Keranjang</a>
                        </div>
                    </div>
